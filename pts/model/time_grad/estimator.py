...
class TimeGradEstimator(PyTorchLightningEstimator):
    """
    Estimator class to train a TimeGrad model.

    This class is uses the model defined in ``TimeGradModel``, and wraps it
    into a ``TimeGradLightningModule`` for training purposes: training is
    ...
    input_size:
        Number of variates in the input time series.
    num_layers
    ...
    def _create_instance_splitter(self, module: TimeGradLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: TimeGradLightningModule,
    ...
    def create_lightning_module(self) -> TimeGradLightningModule:
        return TimeGradLightningModule(
            # loss=self.loss,
            lr=self.lr,
