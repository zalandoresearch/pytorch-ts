...
from .dnri_network import DNRI_TrainingNetwork, DNRI_PredictionNetwork


class DNRIEstimator(PTSEstimator):
    def __init__(
        self,
        input_size: int,
        freq: str,
    ...
    def create_training_network(self, device: torch.device) -> DNRI_TrainingNetwork:
        return DNRI_TrainingNetwork(
    ...
    def create_predictor(
        ...
        trained_network: DNRI_TrainingNetwork,
        device: torch.device,
    ) -> PTSPredictor:
        prediction_network = DNRI_PredictionNetwork(
            input_size=self.input_size,
            target_dim=self.target_dim,
