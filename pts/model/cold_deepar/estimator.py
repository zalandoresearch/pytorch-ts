...
class ColdDeepAREstimator(PyTorchLightningEstimator):
    """
    Estimator class to train a ColdDeepAR model, as described in [SFG17]_.

    This class is uses the model defined in ``ColdDeepARModel``, and wraps it
    into a ``ColdDeepARLightningModule`` for training purposes: training is
    ...
    *Note:* the code of this model is unrelated to the implementation behind
    ...
    def _create_instance_splitter(self, module: ColdDeepARLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: ColdDeepARLightningModule,
    ...
    def create_lightning_module(self) -> ColdDeepARLightningModule:
        return ColdDeepARLightningModule(
            loss=self.loss,
            lr=self.lr,
