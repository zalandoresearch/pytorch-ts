...
class BaseNBEATSEstimator(PyTorchEstimator):

    training_network_cls = None
    prediction_network_cls = None
    valid_n_beats_stack_types = None
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.stack_types = self._validate_nbeats_argument(
            ...
            default_value=["G"],
            validation_condition=lambda val: val in self.valid_n_beats_stack_types,
            invalidation_message=f"Values of 'stack_types' should be one of {self.valid_n_beats_stack_types}",
        )
    ...
    def create_training_network(self, device: torch.device) -> nn.Module:
        return self.training_network_cls(
    ...
    def create_predictor(
        ...
        prediction_network = self.prediction_network_cls(
            prediction_length=self.prediction_length,
            context_length=self.context_length,
            num_stacks=self.num_stacks,
            widths=self.widths,
